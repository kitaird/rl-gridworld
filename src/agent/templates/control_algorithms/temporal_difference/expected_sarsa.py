...
class ExpectedSarsa:
    """
        This is the Temporal Difference learning algorithm Expected Sarsa.
        There is no domain knowledge available.
        The action values should be updated during episode run (online).

        For reference, see Sutton & Barto, Reinforcement Learning: An Introduction, 2018, p. 133, chapter 6.6, Expected Sarsa.
    """

    def __init__(self, env):
        self.algo_name: str = "ExpectedSarsa"
    ...
    def update_action_value(self, state, action, reward, new_state) -> None:
        """
            TODO: Update the action value function using the Expected Sarsa Learning update rule.
        """
        raise NotImplementedError()
    ...
    def expected_sarsa_error(self, s: State, a: Action, r: float, new_s: State) -> float:
        """
            TODO: Calculate the Expected Sarsa Error.
        """
        raise NotImplementedError()

    def expected_sarsa_target(self, reward: float, new_s: State) -> float:
        """
            TODO: Calculate Expected Sarsa Target.
        """
        raise NotImplementedError()
